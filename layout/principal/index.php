  ...
  <div id="wrapper">
    ...
    <header>
      ...
      <div class="container">
        ...
        <div class="row nomargin">
          <div class="span4">
            <div class="logo">
              <a href="index.html"><img src="<?php echo $url; ?>/app/templeates/Eterna/img/logo.png" alt="" /></a>
            </div>
          </div>
          <div class="span8">
    ...
    <section id="featured">
      ...
      <div class="camera_wrap" id="camera-slide">
        ...
        <!-- slide 3 here -->
        <div data-src="<?php echo $url; ?>/app/templeates/Eterna/<?php echo $url; ?>/app/templeates/Eterna/img/slides/camera/slide2/img1.jpg">
          <div class="camera_caption fadeFromLeft">
            <div class="container">
              <div class="row">
